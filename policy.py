...
def _sample_actions_det(
                    actor_def: nn.Module,
                    actor_params: Params,
                    observations: np.ndarray,
                    ) -> jnp.ndarray:
    actions = actor_def.apply({'params': actor_params}, observations)
    return actions


def sample_actions_det(
                   actor_def: nn.Module,
                   actor_params: Params,
                   observations: np.ndarray,
                   ) -> jnp.ndarray:
    return _sample_actions_det(actor_def, actor_params, observations)
